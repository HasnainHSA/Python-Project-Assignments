...
# Mad Libs is a word game where players are prompted for one word at a time, and the
# words are eventually filled into the blanks of a word template to make an 
# entertaining story! We've provided you with the beginning of a sentence 
